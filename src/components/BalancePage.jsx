...
const BalancePage = ({
  ...
  return (
    <div className='balances-page'>
      <h1 className='text-left text-white text-xl font-bold ml-16 '>
        Global Balance
      </h1>
      <div className='global-balances purple-box rounded-xl shadow-lg ml-14 mr-14 pb-2'>
        ...
        <ul className='block mt-8 md:hidden'>
          {balances.map((balance) => (
            <div
              key={balance._id}
              className='green-box p-3 font-semibold grid grid-cols-1'
            >
              <li
                className={
      ...
      <h1 className='text-left text-xl font-bold text-white ml-16'>
        Personal Balance
      </h1>
